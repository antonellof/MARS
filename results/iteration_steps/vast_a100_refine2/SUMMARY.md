...
- **wall p99 (ms):** 0.2798
- **Artifact:** `results/iteration_steps/vast_a100_refine2/step_global_boost_240.json`

## Episode-scoped reference (different contract)

- **composite_score:** 3.0000 (often ~3.0 when both hits saturate)
- **wall p99 (ms):** 0.1569
- **Artifact:** `results/iteration_steps/vast_a100_refine2/step_episode_scoped.json`
