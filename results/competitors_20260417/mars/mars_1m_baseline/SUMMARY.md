...
- **wall p99 (ms):** 2.5066
- **Artifact:** `results/competitors_20260417/mars/mars_1m_baseline/step_global_boost_0.json`

## Episode-scoped reference (different contract)

- **composite_score:** 3.0000 (often ~3.0 when both hits saturate)
- **wall p99 (ms):** 0.1991
- **Artifact:** `results/competitors_20260417/mars/mars_1m_baseline/step_episode_scoped.json`
