...
- **composite_score:** 2.5664
- **ranking_score:** 2.5664
- **wall p99 (ms):** 0.5511
- **Artifact:** `results/iteration_steps/paired_wide_100k/step_global_boost_0.json`

## Episode-scoped reference (different contract)

- **composite_score:** 3.0000 (often ~3.0 when both hits saturate)
- **wall p99 (ms):** 0.1742
- **Artifact:** `results/iteration_steps/paired_wide_100k/step_episode_scoped.json`
