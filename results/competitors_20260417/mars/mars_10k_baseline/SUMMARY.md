...
- **composite_score:** 2.6289
- **ranking_score:** 2.6289
- **wall p99 (ms):** 0.4745
- **Artifact:** `results/competitors_20260417/mars/mars_10k_baseline/step_global_boost_0.json`

## Episode-scoped reference (different contract)

- **composite_score:** 3.0000 (often ~3.0 when both hits saturate)
- **wall p99 (ms):** 0.1916
- **Artifact:** `results/competitors_20260417/mars/mars_10k_baseline/step_episode_scoped.json`
